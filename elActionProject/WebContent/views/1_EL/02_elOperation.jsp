...
<body>
	...
	<h3>1. 산술 연산</h3>
	기존방식(el을 사용하지 않았던 때) : <%= (int)request.getAttribute("big") + (int)request.getAttribute("small") %>
	<br><br>
	...
	10 &lt; 3 = ${ big < small } 또는 ${ bit lt small } <br>
	...
	<!-- el에서의 == 비교는 자바에서의 equals()와 같은 동작을 함 -->
 	...
 	<!-- el안에서 문자열 리터럴 제시시 ""(쌍따옴표) 하고 ''(홑따옴표)를 구분하지 않는다. -->
 	<br> 
